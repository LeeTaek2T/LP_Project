...
-- values
--     ('black', 'XL', 10, '재고있음', current_timestamp, current_timestamp, 1),
--     ('red', 'XL', 10, '재고있음', current_timestamp, current_timestamp, 1),
--     ('blue', 'XL', 10, '재고있음', current_timestamp, current_timestamp, 1);
-- insert into PRODUCT_SKU
--     (color, size, QUANTITY, STATE, CREATED_AT, UPDATED_AT, PRODUCT_ID)
-- values
--     ('black', '24', 10, '재고있음', current_timestamp, current_timestamp, 2),
--     ('red', '28', 10, '재고있음', current_timestamp, current_timestamp, 2),
--     ('blue', '30', 10, '재고있음', current_timestamp, current_timestamp, 2);
